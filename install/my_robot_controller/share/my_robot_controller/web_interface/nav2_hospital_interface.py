...
<body>
    <div class="container">
        ...
        <div class="dashboard">
            ...
            <!-- Right Panel: Locations & Waypoints -->
            <div class="panel">
                <div class="panel-title">
                    <span class="panel-title-icon">🏥</span>
                ...
                <div class="locations-grid">
                    ...
                    <div class="location-card" onclick="goToLocation('entrance')">
                        ...
                        <div class="location-coords">(0.0, 14.0)</div>
                    </div>
                </div>
    ...
    <script>
        ...
        async function goToLocation(location) {
            ...
            try {
                ...
                if (data.status === 'success') {
                    ...
                    showNotification(`Navigation démarrée vers ${location}!`, 'success');
                }
            } catch (error) {
        ...
        function saveWaypoints() {
            // Implementation for saving waypoints
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            drawMap();
            showNotification('Système initialisé', 'success');
        });
    </script>
</body>
</html>
...
# [Suite du fichier nav2_hospital_interface.py]
...
class Nav2WebController(Node):
    def __init__(self):
        ...
        # Hospital locations (from your world file)
        self.hospital_locations = {
            ...
            'consult1': {'x': -7.0, 'y': 9.0, 'name': 'Consultation 1'},
            'consult2': {'x': -1.0, 'y': 9.0, 'name': 'Consultation 2'},
            'consult3': {'x': 7.0, 'y': 9.0, 'name': 'Consultation 3'},
    ...
    def set_command(self, command):
        ...
        self.get_logger().info(f'Command set: {command}')
    ...
    def feedback_callback(self, feedback_msg):
        ...
        # Can process navigation feedback here if needed
    ...
    def navigate_to_location(self, location_id):
        ...
        if location_id in self.hospital_locations:
            ...
            self.get_logger().info(f'🏥 Navigating to {loc["name"]}')
            return self.navigate_to_pose(loc['x'], loc['y'])
...
def goto_location():
    ...
    if nav2_controller.navigate_to_location(location_id):
...
def clear_costmaps():
    """Clear costmaps (would need to call Nav2 service)"""
    # This would typically call a Nav2 service to clear costmaps
...
@app.route('/load_waypoints', methods=['POST'])
def load_waypoints():
    """Load waypoints from file"""
    try:
        import os
        waypoints_file = os.path.expanduser('~/Last_ros/src/my_robot_controller/waypoints/hospital_waypoints.json')
        ...
        if os.path.exists(waypoints_file):
            ...
            waypoints_db.clear()
            waypoints_db.extend(loaded_waypoints)
            ...
            return jsonify({'status': 'error', 'message': 'No waypoints file found'})
    except Exception as e:
        return jsonify({'status': 'error', 'message': str(e)})
...
def main(args=None):
    ...
    print("   • Clavier: W/A/S/D ou flèches ← ↑ → ↓")
